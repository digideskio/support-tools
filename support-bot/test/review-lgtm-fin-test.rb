...
@chatRequests.push('nobody FIN CS-1234 test')
@chatRequests.push('nobody FIN CS-111 test')
respondToPartyChat("[david] #!LGTM CS-222", "support-bot@10genchat.appspotchat.com");
